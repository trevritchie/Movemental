...
- When playing a chord, "borrowing" some notes from the opposite element (not one of the parents) can produce beautiful results (Ex. C maj7, C maj7#5—perhaps these are grandchildren?).
