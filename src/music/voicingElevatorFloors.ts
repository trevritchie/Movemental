 ...
 * - Parent Earth/Wind/Fire (off): Third, Third, Close, Drop 2, Drop 2&4
 *
 * Parents duplicate Third on the lowest two stops so both families share
 * five physical tilt levels. Pairing at each stop:
 * Unison-Third, Triad-Third, Octave-Close, Drop 3-Drop 2,
 * Double Octave-Drop 2&4. The no-tilt dropdown lists Third once.
 */
 ...
 * The lowest two stops both map to Third (inputSteps 1).
 */
export const EVERY_OTHER_PARENT_INPUT_STEPS = [1, 1, 3, 5, 7] as const;
...
/** Dropdown levels for parents (Third once). */
