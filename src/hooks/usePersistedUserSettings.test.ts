...
describe('usePersistedUserSettings', () => {
  ...
  it('skips the initial save on mount', () => {
    const snapshot = {
      ...
      harmonicFunctionLabels: DEFAULT_USER_SETTINGS.harmonicFunctionLabels,
      diagramLayout: DEFAULT_USER_SETTINGS.diagramLayout,
      voicingElevatorFloors: DEFAULT_USER_SETTINGS.voicingElevatorFloors,
